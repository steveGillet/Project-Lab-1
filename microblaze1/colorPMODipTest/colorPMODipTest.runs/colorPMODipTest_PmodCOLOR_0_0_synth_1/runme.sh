...
HD_PWD='C:/Users/steph/OneDrive/Desktop/School/ProjectLab1/microblaze1/colorPMODipTest/colorPMODipTest.runs/colorPMODipTest_PmodCOLOR_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log colorPMODipTest_PmodCOLOR_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source colorPMODipTest_PmodCOLOR_0_0.tcl
