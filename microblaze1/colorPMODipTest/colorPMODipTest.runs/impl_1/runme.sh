...
HD_PWD='C:/Users/steph/OneDrive/Desktop/School/ProjectLab1/microblaze1/colorPMODipTest/colorPMODipTest.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log projectLab1b.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source projectLab1b.tcl -notrace
