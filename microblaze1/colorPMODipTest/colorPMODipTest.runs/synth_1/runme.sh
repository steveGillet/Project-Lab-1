...
HD_PWD='C:/Users/steph/OneDrive/Desktop/School/ProjectLab1/microblaze1/colorPMODipTest/colorPMODipTest.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log projectLab1b.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source projectLab1b.tcl
