...
HD_PWD='C:/Users/steph/OneDrive/Desktop/School/ProjectLab1/microblaze1/microblaze1/microblaze1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log microblaze1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source microblaze1.tcl -notrace
