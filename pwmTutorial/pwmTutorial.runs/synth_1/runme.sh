...
HD_PWD='C:/Users/steph/OneDrive/Desktop/School/ProjectLab1/pwmTutorial/pwmTutorial.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pwmTutorial.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pwmTutorial.tcl
