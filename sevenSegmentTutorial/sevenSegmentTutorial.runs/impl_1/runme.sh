...
HD_PWD='C:/Users/steph/OneDrive/Desktop/School/ProjectLab1/sevenSegmentTutorial/sevenSegmentTutorial.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sevenSegment1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sevenSegment1.tcl -notrace
