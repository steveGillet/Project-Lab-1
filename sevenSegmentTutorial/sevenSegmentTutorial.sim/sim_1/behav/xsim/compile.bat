...
REM
REM Generated by Vivado on Fri Sep 10 20:33:59 -0500 2021
...
echo "xvlog --incr --relax -prj sevenSegTestBench_vlog.prj"
call xvlog  --incr --relax -prj sevenSegTestBench_vlog.prj -log xvlog.log
