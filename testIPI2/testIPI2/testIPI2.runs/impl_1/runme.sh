...
HD_PWD='C:/Users/steph/OneDrive/Desktop/School/ProjectLab1/testIPI2/testIPI2/testIPI2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log testIPI2_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source testIPI2_wrapper.tcl -notrace
