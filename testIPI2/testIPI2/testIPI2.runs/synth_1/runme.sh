...
HD_PWD='C:/Users/steph/OneDrive/Desktop/School/ProjectLab1/testIPI2/testIPI2/testIPI2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log testIPI2_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source testIPI2_wrapper.tcl
