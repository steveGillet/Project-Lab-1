...
HD_PWD='C:/Users/steph/OneDrive/Desktop/School/ProjectLab1/testIPI2/testIPI2/testIPI2.runs/testIPI2_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log testIPI2_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source testIPI2_xbar_0.tcl
